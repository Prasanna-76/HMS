...
function Copyright(props) {
    return (
        <Typography variant="body2" color="text.secondary" align="center" {...props}>
            {'Developed with 🖤 by '}
            <strong><a className='text-style' href="#" target="_blank" rel="noreferrer noopener">DYSK</a> </strong>{'Copyright ©'}
                    ...
                    <Grid container
                        ...
                        <Grid sx={{ m: 'auto' }} item xs={12} sm={6} md={4}>
                            <Box>
                                ...
                                > <Avatar sx={{mt:1, mb: 1, mr: 1, bgcolor: 'white' }}>
                                    ...
                                    DYSK Multi Speciality Hospital
                                </Typography>
                                <Divider />
                            </Box>
                            ...
                            <Stack direction="row"
                                ...
                                <Avatar sx={{ mt: 1, bgcolor: pink[500] }}>
                                    <LocationOnIcon />
                                </Avatar><span>Gangalakurru ,Amalapuram</span>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="mailto:pkprasanna2203@gmail.com">
                                pkprasanna2203@gmail.com
                                </a>
                            </Stack >
                        ...
                        <Grid item xs={12} sm={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://www.linkedin.com/in/prasanna-priya-kagitapalli-6172432b4/" target="_blank" rel="noopener noreferrer" >
                                    LinkedIn
                                </a>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://github.com/Prasanna-76" target="_blank" rel="noopener noreferrer" >
                                    GitHub
                                </a>
                            </Stack >
